...
//						post.img = img;
                        ...
                        var feedbackData = {};
//                        feedbackData.post = post;

                        feedbackData.From = 'kz@yukonsolns.com';
                        feedbackData.To = 'yukonsolns@gmail.com';
                        feedbackData.Subject = 'Prototype Feedback';
                        var htmlBody = '<html><body>';
                        $.each(post, function(key, value) {
                            htmlBody += '<label>' + key + '</label>';
                            htmlBody += '<div>' + value + '</div>';
                        })
                        htmlBody += '</body></html>';
                        feedbackData.htmlBody = htmlBody;

                        var headers = {
                            'Access-Control-Allow-Origin': '*',
                            'X-Postmark-Server-Token': '3db5634c-b1eb-4394-bec9-d42e64df1181'
                        };
